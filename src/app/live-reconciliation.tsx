...
export default async function LiveReconciliation({
  ...
  const processPayment = (payment: any, isIncoming: boolean) => {
    ...
    const addLeg = (accountCode: string, localVal: number, fcVal: number | null, legTipo: "IN" | "OUT") => {
      const bankName = TRANSFER_ACCOUNT_NAMES[accountCode] || accountCode;
    ...
    if (mainAcc) {
      ...
      addLeg(mainAcc, mainVal, null, isIncoming ? "IN" : "OUT");
    }
